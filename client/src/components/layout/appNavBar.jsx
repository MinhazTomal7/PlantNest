                ...
                <div className="container">
                    <div className="row justify-content-around">
                        <div className="col-md-6">
                            <span className="f-12"><i className="bi bi-envelope"></i> Support@PlantNest.com</span>
                            <span className="f-12 mx-2"><i className="bi bi-telephone"></i> 01995067637</span>
                        </div>
            ...
            <nav className="navbar sticky-top bg-white navbar-expand-lg navbar-light py-3">
                <div className="container">
                    <Link className="navbar-brand" to="/">
                        <img className="img-fluid" src={logo} alt="PlantNest Logo" width="96px" />
                    </Link>
                    ...
                    <div className="d-lg-flex">
...

                        {
                            isLogin() ? (
                                ...
                                <Link to="/login" className="btn ms-3 btn-success d-flex">Login</Link>
                            )
                        }
                    </div>
                </div>
